...
void suite("JSON references", () => {
  ...
  void test("resolves reference to resource node", () => {
    const context = createContext();
    const targetNode = { type: "string" };
    const resource = createResource(
      "https://example.com/string.json",
  ...
  void test("resolves multiple references", () => {
    const context = createContext();
    ...
    const types = createResource(
      "https://example.com/types.json",
      { string: stringType, number: numberType },
    );
  ...
  void test("throws for unknown resource", () => {
    const context = createContext();
  ...
  void test("throws for invalid fragment", () => {
    const context = createContext();
  ...
  void test("aggregates multiple resolution errors", () => {
    const context = createContext();
  ...
  void test("resolves references relative to base resource", () => {
    const context = createContext();
    ...
    resolveReferences(context, baseResource);
    assert.equal(reference.target, targetNode);
  });

  void test("handles empty unresolved map", () => {
    const context = createContext();
    const resource = createResource(undefined, {});

    // Should not throw
    resolveReferences(context, resource);
  });

  void test("relocates single reference", () => {
    const context = createContext();
  ...
  void test("preserves root nodes", () => {
    const context = createContext();
    ...
    resolveReferences(context, createResource(undefined, rootNode));
  ...
  void test("handles shared references", () => {
    const context = createContext();
  ...
  void test("handles cyclic references", () => {
    const context = createContext();
  ...
  void test("applies transformations during rewriting", () => {
    const context = createContext();
  ...
  void test("handles reference chains", () => {
    const context = createContext();
  ...
  void test("handles empty reference targets", () => {
    const context = createContext();
    const emptyNode = {};
  ...
  void test("handles multiple root nodes", () => {
    const context = createContext();
    ...
    resolveReferences(context, createResource(undefined, container));
